...
object AqlWsContract {
    ...
    const val ACTION_LIGHT_THERMAL_STATUS_GET = "thermal.status.get"
    const val ACTION_LIGHT_THERMAL_CONFIG_APPLY = "thermal.config.apply"

    const val ACTION_COOLING_STATUS_GET = ACTION_STATUS_GET
    const val ACTION_COOLING_CONFIG_APPLY = ACTION_CONFIG_APPLY
    const val ACTION_COOLING_MANUAL_APPLY = "manual.apply"
    const val ACTION_COOLING_PROGRAM_GET = "program.get"
    const val ACTION_COOLING_PROGRAM_APPLY = "program.apply"
    const val ACTION_COOLING_HISTORY_GET = "history.get"
    ...
    private val authenticatedCommands = setOf(
        ...
        commandKey(MODULE_LIGHT, ACTION_LIGHT_THERMAL_CONFIG_APPLY),
        commandKey(MODULE_COOLING, ACTION_COOLING_CONFIG_APPLY),
        commandKey(MODULE_COOLING, ACTION_COOLING_HISTORY_GET),
        commandKey(MODULE_COOLING, ACTION_COOLING_MANUAL_APPLY),
        commandKey(MODULE_COOLING, ACTION_COOLING_PROGRAM_APPLY),
        commandKey(MODULE_COOLING, ACTION_COOLING_PROGRAM_GET),
