...
/** Internal bridge from the existing per-device runtime repository to the common executor. */
internal data class DeviceRuntimeCommandSession(
    val deviceUid: DeviceUid,
    val generation: DeviceRuntimeConnectionGeneration,
    val authenticated: Boolean,
    val send: (com.aqua.aqualight.data.devices.runtime.ws.AqlWsOutgoingMessage) -> Boolean
)
