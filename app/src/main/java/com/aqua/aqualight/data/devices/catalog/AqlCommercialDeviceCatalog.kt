...
internal object AqlCommercialDeviceCatalog {
    ...
    private fun compareProfile(
        ...
        // supportedFeatures/supportedScreens are authenticated runtime availability, not immutable
        // product identity. Missing optional support must gate only the affected surface.
