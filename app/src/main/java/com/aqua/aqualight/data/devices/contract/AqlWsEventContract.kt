...
object AqlWsEventContract {
    ...
    const val ACTION_LIGHT_THERMAL_STATUS_CHANGED = "thermal.status.changed"
    const val ACTION_LIGHT_THERMAL_TELEMETRY_CHANGED = "thermal.telemetry.changed"
    const val ACTION_COOLING_TELEMETRY_CHANGED = "telemetry.changed"
    ...
    private val registeredEvents = linkedSetOf(
        ...
        Definition(AqlWsContract.MODULE_LIGHT, ACTION_LIGHT_THERMAL_STATUS_CHANGED),
        Definition(AqlWsContract.MODULE_LIGHT, ACTION_LIGHT_THERMAL_TELEMETRY_CHANGED),
        Definition(AqlWsContract.MODULE_COOLING, ACTION_STATUS_CHANGED),
        Definition(AqlWsContract.MODULE_COOLING, ACTION_COOLING_TELEMETRY_CHANGED),
