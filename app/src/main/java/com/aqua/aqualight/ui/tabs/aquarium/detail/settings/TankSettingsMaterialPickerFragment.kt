...
class TankSettingsMaterialPickerFragment : Fragment(R.layout.fragment_material_picker) {
    ...
    private fun observeTank() {
        aquariumTankViewModel.tanks.observe(viewLifecycleOwner) { tanks ->
            ...
            currentTank = tank
            allProducts = buildProductList(tank)
    ...
    private fun buildProductList(
        ...
        val customProducts = tank.materials
            .filter { it.categoryKey == categoryKey }
            .filterNot { selection ->
    ...
    private fun setupClickListeners() {
        binding.btnBack.setOnClickListener {
            (requireParentFragment() as? TankSettingsFragment)
    ...
    private fun saveSelections() {
        ...
        val currentCategoryMaterials = tank.materials.filter { material ->
    ...
    companion object {
        ...
        ): TankSettingsMaterialPickerFragment {
            return TankSettingsMaterialPickerFragment().apply {
                arguments = bundleOf(
