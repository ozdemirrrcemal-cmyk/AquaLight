...
// Delivers a clearly high-output visual while retaining enough samples per revolution for smooth
// motion on 60 Hz displays. Frame-clock integration preserves continuous acceleration.
private const val FULL_OUTPUT_FAN_MOTION_MILLIS = 280f
