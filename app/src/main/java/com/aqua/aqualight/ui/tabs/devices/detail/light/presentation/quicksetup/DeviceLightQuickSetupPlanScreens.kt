...
@Composable
private fun QuickSetupManagedPlanCard(
    productName: String,
...
@Composable
private fun QuickSetupLiveChart(
...
private fun DeviceLightQuickSetupRecommendation.currentPhaseIndex(): Int {
...
private fun AquariumPlantLightDemand.demandResource(): Int = when (this) {
