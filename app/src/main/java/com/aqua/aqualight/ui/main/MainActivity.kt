...
class MainActivity : BaseActivity() {
    ...
    companion object {
        ...
        const val EXTRA_OPEN_DEVICE_FIRMWARE_UPDATE_UID =
            "EXTRA_OPEN_DEVICE_FIRMWARE_UPDATE_UID"
    ...
    override fun onCreate(
        ...
        navigationCoordinator = MainNavigationCoordinator(
            ...
            canOpenDeviceFirmwareUpdate =
                requireAppContainer().deviceFirmwareNotificationRouteOperations::canOpen
        )
    ...
    override fun onNewIntent(
        ...
        navigationCoordinator.consumePendingNotificationsIfPossible()
    }
    ...
    fun clearSessionNavigationState() {
        ...
        intent?.removeExtra(EXTRA_OPEN_DEVICE_FIRMWARE_UPDATE_UID)
