...
Fragment(R.layout.fragment_device_dosing_channel_settings) {
    ...
    private fun maybeOpenCalibrationFirst() {
        ...
        binding.root.post {
            ...
            if (
                ...
                R.id.deviceDosingChannelSettingsFragment
            ) {
    ...
    companion object {
        ...
        private const val ARG_OPEN_CALIBRATION_FIRST =
        "openCalibrationFirst"
