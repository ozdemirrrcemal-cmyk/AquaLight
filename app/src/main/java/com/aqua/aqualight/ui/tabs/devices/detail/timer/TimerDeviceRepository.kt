...
class TimerDeviceRepository {
    ...
    data class TimerDashboardData(
        ...
        fun nextEvent(): TimerNextEventResolver.NextTimerEvent? {
            return TimerNextEventResolver.resolve(
                data = this
            )
        }
        ...
        fun nextEventText(): String {
            return nextEvent()?.topCardText() ?: "--"
        }

        fun nextTimerDescription(): String {
            return nextEvent()?.detailText() ?: "No scheduled timer."
        }
    }
