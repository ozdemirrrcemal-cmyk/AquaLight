...
class DeviceConfirmBottomSheet private constructor(
    ...
    fun show(
        ...
        val iconView = view.findViewById<ImageView>(R.id.ivConfirmIcon)
        val titleView = view.findViewById<TextView>(R.id.tvConfirmTitle)
        val messageView = view.findViewById<TextView>(R.id.tvConfirmMessage)
        val cancelButton = view.findViewById<MaterialButton>(R.id.btnConfirmCancel)
        val confirmButton = view.findViewById<MaterialButton>(R.id.btnConfirmPrimary)
