...
private val wioDecorationDefinitions = listOf(
    decoration(
        id = "decoration_0001",
...
private val creaquaDecorationDefinitions = listOf(
    decoration(
        id = "decoration_0071",
...
private val unsDecorationDefinitions = listOf(
    decoration(
        id = "decoration_0084",
...
private val greenworksDecorationDefinitions = listOf(
    decoration(
        id = "decoration_0174",
...
private val riverestDecorationDefinitions = listOf(
    decoration(
        id = "decoration_0199",
...
private val aquadecoDecorationDefinitions = listOf(
    decoration(
        id = "decoration_0203",
...
object DecorationCatalog {
    ...
    val definitions: List<AquariumMaterialDefinition> =
        wioDecorationDefinitions +
            adaDecorationDefinitions +
            creaquaDecorationDefinitions +
            unsDecorationDefinitions +
            greenworksDecorationDefinitions +
            riverestDecorationDefinitions +
            aquadecoDecorationDefinitions +
            aquaelDecorationDefinitions +
            dennerleDecorationDefinitions +
            istaDecorationDefinitions
}
