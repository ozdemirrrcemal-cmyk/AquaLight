...
object AlgaeKnowledgeCatalog {
    ...
    val records: List<AlgaeKnowledgeProfile> = listOf(
        profile(
            ...
            evidence = setOf("ACO_DIATOM", "2HRA_ALGAE_TYPES")
        ),
        profile(
            ...
            factors = mapOf(
                ...
                AlgaeFactorId.LOW_PHOSPHATE_CONTEXT to 4,
                AlgaeFactorId.ORGANIC_LOAD to 2,
            ...
            evidence = setOf("ACO_GSA", "2HRA_GSA")
        ),
        profile(
            ...
            evidence = setOf("ACO_BBA", "2HRA_BBA")
        ),
        profile(
            ...
            factors = mapOf(
                ...
                AlgaeFactorId.PLANT_STRESS to 3,
                AlgaeFactorId.NITROGEN_WASTE to 2
            ),
            actions = listOf(
                AlgaeActionId.MANUAL_REMOVAL,
            ...
            evidence = setOf("ACO_HAIR", "2HRA_ALGAE_TYPES")
        ),
        profile(
            ...
            evidence = setOf("2HRA_ALGAE_TYPES", "ACO_HAIR")
        ),
        profile(
            ...
            factors = mapOf(
                ...
                AlgaeFactorId.LOW_PLANT_MASS to 3,
            ...
            evidence = setOf("2HRA_GDA", "2HRA_ALGAE_TYPES")
        ),
        profile(
            ...
            evidence = setOf("ACO_BGA", "2HRA_ALGAE_TYPES")
        ),
        profile(
            ...
            evidence = setOf("ACO_GREEN_WATER", "2HRA_GREEN_WATER")
        ),
        profile(
            ...
            evidence = setOf("2HRA_ALGAE_TYPES")
        )
    )
    ...
    init {
        ...
        require(records.all { record -> record.evidenceKeys.isNotEmpty() })
    }
