...
class DeviceNetworkStatusParserTest {
    ...
    private fun statusJson(): JSONObject = JSONObject()
        ...
        .put("setupAp", setupApJson())
        .put("discovery", discoveryJson())
        .put("runtime", runtimeJson())

    private fun clientJson(): JSONObject = JSONObject()
        .put("enabled", true)
        .put("configured", true)
        .put("ssid", "Home WiFi")
    ...
    private fun setupApJson(): JSONObject = JSONObject()
        .put("enabled", true)
        .put("active", true)
    ...
    private fun discoveryJson(): JSONObject = JSONObject()
        .put("ready", true)
        .put("port", 45_454)
