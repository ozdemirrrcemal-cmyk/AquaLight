...
| K03 | Ana semantik kararlar alındı; uygulama/veri işi açık | K03.0–K03.13 ile desteklenen ölçümlerin canonical semantics/unit/source-resolution davranışı kabul edildi; GH=`GENERAL_HARDNESS` canonical mg/L as CaCO3, verified dGH UI/source conversion ile tamamlandı. | Yeni kimya semantiği açmadan verified profile catalog, conversion revisions/precision, method range/detection metadata ve golden-vector verileri uygulanmalı. Input precision/bounded-result K11; threshold/rule evidence K04/W0.4 kapsamında. |
...
- [ ] W0.6 K03.5–K03.13 politikalarını uygula: önceki marine/DO/chlorine/Ca-Mg/conductivity-TDS/CO2/Fe-K kurallarına ek olarak GH=`GENERAL_HARDNESS` canonical `mg/L as CaCO3`; verified dGH source/display conversion; GH≠KH/alkalinity≠elemental Ca/Mg; unknown hardness basis fail-closed. K03 ana semantik kararları burada tamamlanır.
