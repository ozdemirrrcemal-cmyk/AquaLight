...
| K03 | Kısmen kararlaştırıldı; kalanlar kritik | K03.0–K03.7'ye ek olarak K03.8 ile free/total chlorine ayrı `mg/L as Cl2`, combined chlorine same-sample derived-only, direct monochloramine specific-method-only ve raw/conditioned/tank sample-context izolasyonu kabul edildi. | Sıradaki K03.9: Ca/Mg elemental reporting basis ve units. Ardından conductivity/TDS, CO2, Fe/K ve diğer ek ölçümler; kanıtlı profile/precision tamamlanmalı. |
...
- [ ] W0.6 K03.5–K03.8 politikalarını uygula: salinity/SG/conductivity/mass-salinity ayrı typed metric; `TOTAL_ALKALINITY` canonical meq/L; DO mg/L/% saturation same-event policy; chlorine family için `FREE_CHLORINE_AS_CL2`, `TOTAL_CHLORINE_AS_CL2`, derived `COMBINED_CHLORINE_AS_CL2`, direct `MONOCHLORAMINE_AS_CL2`; raw/conditioned/tank sample contexts ayrılır. Combined yalnız compatible same-sample free+total pair'den türetilir; total<free clamped/negative sonuç üretmez; direct mono yalnız specific verified method. Ardından §25.2'deki diğer ek ölçüm semantiklerini kesinleştir.
...
- [ ] W1.1 K02 kararına göre mevcut AquariumWaterParameter ve AquariumWaterSnapshot modellerini kontrollü genişlet; K03.1–K03.8 anlam/birimleriyle NO2, TAN, direct NH3, PSS-78/SG, alkalinity/KH, DO concentration/saturation, `FREE_CHLORINE_AS_CL2`, `TOTAL_CHLORINE_AS_CL2`, `MONOCHLORAMINE_AS_CL2` ve gereken derived result türlerini ekle; ppm/dKH/KH/% veya generic chlorine etiketlerini anlam değiştirerek sessizce kullanma.
...
- [ ] W1.4 Parse/normalization öncesi anlamı koru; K03.2/K03.5/K03.7/K03.8 typed source profile politikasını kullan. Ham değer, source/profile/revision, sample context/time, method/matrix applicability, compensation ve normalize/derived provenance gerektiği yerde ayrı izlenebilir olsun. Chlorine combined derivation yalnız same-sample compatible pair üzerinde çalışsın; mono-chloramine subtraction ile üretilmesin. Yuvarlama yalnız sunumda.
...
- [ ] W9.3 K03.2–K03.8 semantic/unit/source tests geçsin: ammonia, salinity/SG, alkalinity, DO ve chlorine family; free/total mg/L as Cl2; same-sample combined derivation; total<free inconsistency; direct monochloramine specific-method-only; raw/conditioned/tank context isolation; unsupported matrix/interference; same-test multi-result; no false chloramine inference; conversion/derivation provenance; unsupported→INSUFFICIENT_DATA; locale, precision, nonfinite, negatif, aşırı büyük sayı, boş/sıfır ve zaman.
