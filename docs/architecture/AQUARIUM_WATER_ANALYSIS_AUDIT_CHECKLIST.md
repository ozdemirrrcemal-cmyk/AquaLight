...
| İletkenlik/TDS, CO2, demir ve potasyum ek ölçümleri | §25.2–25.3; W0.2, W0.6, W8.1 | Conductivity/TDS K03.10, CO2 K03.11 ile kesinleşti. Direct CO2 mg/L as CO2; direct yoksa compatible same-event pH+KH üzerinden `Hesaplanan CO2`; drop-checker ppm üretmez. Fe/K semantiği açık |
...
| K03 | Kısmen kararlaştırıldı; kalanlar kritik | K03.0–K03.10'a ek olarak K03.11 ile direct CO2=`mg/L as CO2`, same-event compatible pH+KH calculated CO2, direct-primary/no-overwrite, pH-only rejection ve drop-checker→ppm yasağı kabul edildi. | Sıradaki K03.12: Fe/K semantics. Ardından kalan ek ölçümler; kanıtlı profile/precision tamamlanmalı. |
...
- [ ] W0.6 K03.5–K03.11 politikalarını uygula: önceki marine/DO/chlorine/Ca-Mg/conductivity-TDS kurallarına ek olarak direct CO2=`mg/L as CO2`; direct yoksa compatible same-event pH+typed KH ile versioned `Hesaplanan CO2`; pH tek başına hesap yapmaz; direct ve calculated ayrı provenance taşır; drop-checker ppm üretmez. Ardından Fe/K ve diğer ek ölçüm semantiklerini kesinleştir.
...
- [ ] W1.1 K02 kararına göre mevcut AquariumWaterParameter ve AquariumWaterSnapshot modellerini kontrollü genişlet; K03.1–K03.11 anlam/birimleriyle `ELECTRICAL_CONDUCTIVITY`, `TDS_REPORTED_PPM`, `DISSOLVED_CO2_CONCENTRATION` ve `CALCULATED_DISSOLVED_CO2_CONCENTRATION` desteğini ekle. Direct/derived provenance modelde ayrı olsun.
...
- [ ] W9.3 K03.2–K03.11 semantic/unit/source tests geçsin: conductivity/TDS testlerine ek olarak direct CO2 mg/L round-trip; same-event pH+KH calculation golden vectors; incompatible/unresolved KH rejection; pH-only no-CO2; historical pH/KH substitution rejection; direct+calculated coexistence with direct primary/no overwrite; drop-checker color not mapped to ppm; missing prerequisites→INSUFFICIENT_DATA.
