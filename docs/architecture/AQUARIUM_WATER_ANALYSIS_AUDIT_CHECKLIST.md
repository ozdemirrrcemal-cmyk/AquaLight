...
| K03 | Kısmen kararlaştırıldı; kalanlar kritik | K03.0–K03.8'e ek olarak K03.9 ile reef calcium=`mg/L as Ca2+`, magnesium=`mg/L as Mg2+`, hardness/GH ayrımı, matrix/method ve difference-derived provenance politikası kabul edildi. | Sıradaki K03.10: conductivity/TDS semantics + temperature/reference + conversion-factor policy. Ardından CO2, Fe/K ve diğer ek ölçümler; kanıtlı profile/precision tamamlanmalı. |
...
- [ ] W0.6 K03.5–K03.9 politikalarını uygula: salinity/SG, alkalinity, DO, chlorine family ve reef Ca/Mg typed semantics. `CALCIUM_CONCENTRATION`=`mg/L as Ca2+`, `MAGNESIUM_CONCENTRATION`=`mg/L as Mg2+`; hardness-as-CaCO3/GH ayrı tutulur; difference-derived Mg direct elemental ölçüm gibi gösterilmez; marine matrix/range/dilution/interference source profile'da doğrulanır. Ardından §25.2'deki conductivity/TDS ve diğer ek ölçüm semantiklerini kesinleştir.
...
- [ ] W1.1 K02 kararına göre mevcut AquariumWaterParameter ve AquariumWaterSnapshot modellerini kontrollü genişlet; K03.1–K03.9 anlam/birimleriyle NO2, TAN/direct NH3, PSS-78/SG, alkalinity/KH, DO, chlorine family, `CALCIUM_CONCENTRATION`, `MAGNESIUM_CONCENTRATION` ve gereken hardness/derived result türlerini ekle; ppm/dKH/KH/%/hardness etiketlerini anlam değiştirerek sessizce kullanma.
...
- [ ] W9.3 K03.2–K03.9 semantic/unit/source tests geçsin: ammonia, salinity/SG, alkalinity, DO, chlorine family ve Ca/Mg; elemental Ca2+/Mg2+ mapping; generic ppm basis rejection; hardness-as-CaCO3/GH separation; explicit hardness→elemental conversion golden vectors where supported; difference-derived magnesium provenance; marine matrix/range/interference rejection; unsupported→INSUFFICIENT_DATA; locale, precision, nonfinite, negatif, aşırı büyük sayı, boş/sıfır ve zaman.
