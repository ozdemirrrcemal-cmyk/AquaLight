...
Bu kayıt kabul edilen kararları belgeler; paketlerin/kodun uygulanmış olduğunu göstermez. W0.1, K03 uygulama/veri işleri ve K04–K18 açık olduğu için kapanmaz. **K03.0–K03.14 ile desteklenen ölçümlerin ana kimyasal semantik/birim kararları ve ilk sürüm serbest NH3 hesabı politikası kapatıldı.** K03 altında kalan iş doğrulanmış test/cihaz profil kataloğu, conversion revision/hassasiyeti, method range/detection-limit metadata'sı ve golden-vector test verilerinin uygulanmasıdır. Ek ölçümleri açma ve yardım etkileşimi K13/UI kararlarında; input precision/bounded-result politikası K11'de tamamlanacaktır.
