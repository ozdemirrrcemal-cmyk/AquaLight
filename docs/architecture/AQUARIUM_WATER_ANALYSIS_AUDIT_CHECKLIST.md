...
Bu kayıt kabul edilen kararları belgeler; paketlerin/kodun uygulanmış olduğunu göstermez. W0.1, K03'ün kalan kararları ve K04–K18 açık olduğu için kapanmaz. **K03.0 ölçüm kapsamını, K03.1 yalnız NO3/NO2/PO4 kanonik kayıt anlamı ve birimlerini kapatır.** Sıradaki karar: **W0.1 / K03.2 — kaynak birimleri ve dönüşüm politikası**. Toplam amonyağın kesin raporlama temeli, desteklenen test profilleri ve ek ölçümlerin semantiği daha sonra ayrı ayrı ele alınacaktır. Ek ölçümleri açma etkileşimi ayrıca kararlaştırılacak; kapsam onayı yeni görsel düzen onayı değildir.

K03.1'in doğrulanan kaynakları, kabul edilen kayıt standardı ve henüz onaylanmamış K03.2 önerisi: [Konsantrasyon birimleri araştırma notu](research/WATER_ANALYSIS_CONCENTRATION_UNITS_K03.md).
...
| K03 | Kısmen kararlaştırıldı; kalanlar kritik | K03.0 ölçüm kapsamı (§25), K03.1 NO3/NO2/PO4 kanonik anlam ve birimleri (§6.1) kabul edildi. | K03.2 kaynak/ppm dönüşüm politikası; toplam amonyak raporlama temeli; tuzluluk/SG, KH/alkalinite ve ek ölçümler; desteklenmeyen test sonucu davranışı kesinleşsin. Katalogdaki kaynak değerler yeni standarda göre kendiliğinden doğrulanmış sayılmaz. |
