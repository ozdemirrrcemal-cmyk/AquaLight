...
Bu kayıt kabul edilen kararları belgeler; paketlerin/kodun uygulanmış olduğunu göstermez. W0.1, K03'ün kalan kararları ve K04–K18 açık olduğu için kapanmaz. **K03.0 ölçüm kapsamını, K03.1 NO3/NO2/PO4 kanonik kayıt anlamı ve birimlerini, K03.2 test/cihaz seçimi + kaynak semantiği çözümleme + normalizasyon akışını, K03.3 amonyak kanonik temellerini ve K03.4 çok-sonuçlu aynı-olay cardinality/UI davranışını kapatır.** Sıradaki karar: **W0.1 / K03.5 — deniz/resif için tuzluluk ile specific gravity'nin kanonik kayıt, sıcaklık referansı ve dönüşüm politikası**. Tam ticari test kataloğu içerikleri, kanıtlı dönüşüm katsayıları/hassasiyetleri ve diğer ek ölçümlerin semantiği kendi maddelerinde tamamlanacaktır. Ek ölçümleri açma ve yardım etkileşimi ayrıca kararlaştırılacak; kapsam onayı yeni görsel düzen onayı değildir.

K03.1'in doğrulanan kaynakları ile kabul edilen K03.2 kaynak-seçim/normalizasyon, K03.3 amonyak kanonik ve K03.4 çok-sonuçlu kayıt/UI davranışı: [Konsantrasyon birimleri araştırma notu](research/WATER_ANALYSIS_CONCENTRATION_UNITS_K03.md).
...
| K03 | Kısmen kararlaştırıldı; kalanlar kritik | K03.0 ölçüm kapsamı (§25), K03.1 NO3/NO2/PO4 kanonik anlam/birimleri (§6.1), K03.2 test/cihaz seçimi + kaynak çözümleme + normalizasyon, K03.3 TAN=`mg/L as N` / direct NH3=`mg/L as NH3` ve K03.4 concurrent multi-result ayrı metric/alan davranışı kabul edildi. | Sıradaki K03.5: tuzluluk/SG kanonik semantik, sıcaklık referansı ve dönüşüm politikası. Ardından KH/alkalinite ve ek ölçümler; kanıtlı profil/dönüşüm katsayıları ve precision tamamlanmalı. Çözülemeyen test semantiği commit edilmez; katalogdaki eski kaynak değerler yeni standarda göre kendiliğinden doğrulanmış sayılmaz. |
...
- [ ] W9.3 Birim/ammonia semantiği, K03.2–K03.4 parametre bazlı test/cihaz seçimi, profil/guided fallback, concurrent multi-result ayrı alan + aynı-record round-trip, mutually-exclusive mode selector, TAN/direct NH3 overwrite etmeme, unresolved-draft davranışı, source-change sonrası sessiz yeniden anlamlandırmama, raw→normalized provenance round-trip, decimal locale, precision, nonfinite, negatif, aşırı büyük sayı, boş/sıfır ve zaman testleri geçsin.
