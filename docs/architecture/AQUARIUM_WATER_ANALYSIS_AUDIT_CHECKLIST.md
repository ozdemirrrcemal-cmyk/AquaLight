...
| W0.1 / K03.11 | Profesyonel güvenlik standardı olarak kararlaştırıldı — 26.09.2026 | Direct `DISSOLVED_CO2_CONCENTRATION` canonical `mg/L as CO2`. pH/KH chart, pH-drop, drop-checker veya benzeri indirect çıktılar measured CO2 sayılmaz; `ESTIMATED_DISSOLVED_CO2_CONCENTRATION`/indicator olarak derivation provenance ile ayrılır. Bare current pH+KH hard CO2 health/dosing sonucu üretmez. Direct result indirect estimate'i override eder; indirect estimate direct measurement yerine geçmez. Historical estimate bugünkü pH/KH/sensor context'i kullanmaz. Equipment presence concentration değildir. Prerequisite/assumption eksikse `INSUFFICIENT_DATA` / estimate unavailable. | Ana sözleşme §6.13, §25.2, §43.4 ve §46 |

Bu kayıt kabul edilen kararları belgeler; paketlerin/kodun uygulanmış olduğunu göstermez. W0.1, K03'ün kalan kararları ve K04–K18 açık olduğu için kapanmaz. **K03.0 ölçüm kapsamını, K03.1 NO3/NO2/PO4 kanonik kayıt anlamı ve birimlerini, K03.2 test/cihaz seçimi + kaynak semantiği çözümleme + normalizasyon akışını, K03.3 amonyak kanonik temellerini, K03.4 çok-sonuçlu aynı-olay cardinality/UI davranışını, K03.5 deniz salinity/SG dönüşüm güvenliğini, K03.6 alkalinite/KH semantiğini, K03.7 çözünmüş oksijen, K03.8 klor/kloramin, K03.9 elemental Ca/Mg, K03.10 conductivity/TDS ve K03.11 direct-vs-derived CO2 politikasını kapatır.** Sıradaki karar: **W0.1 / K03.12 — demir ve potasyumun kanonik elemental/compound basis, test-method semantiği ve gübre doz önerilerinden ayrılması**. Tam ticari test kataloğu içerikleri, kanıtlı dönüşüm katsayıları/hassasiyetleri ve diğer ek ölçümlerin semantiği kendi maddelerinde tamamlanacaktır. Ek ölçümleri açma ve yardım etkileşimi ayrıca kararlaştırılacak; kapsam onayı yeni görsel düzen onayı değildir.

K03.1'in doğrulanan kaynakları ile kabul edilen K03.2 kaynak-seçim/normalizasyon, K03.3 amonyak kanonik, K03.4 çok-sonuçlu kayıt/UI, K03.5 deniz salinity/SG, K03.6 alkalinite/KH, K03.7 çözünmüş oksijen, K03.8 klor/kloramin, K03.9 Ca/Mg, K03.10 conductivity/TDS ve K03.11 CO2 güvenlik davranışı: [Konsantrasyon birimleri araştırma notu](research/WATER_ANALYSIS_CONCENTRATION_UNITS_K03.md).
...
| İletkenlik/TDS, CO2, demir ve potasyum ek ölçümleri | §25.2–25.3; W0.2, W0.6, W8.1 | Conductivity/TDS K03.10, CO2 K03.11 ile kesinleşti. CO2 direct mg/L measured; pH/KH/drop-checker derived değerler ayrı ve hard assessment kaynağı değil. Fe/K semantiği açık |
...
| K03 | Kısmen kararlaştırıldı; kalanlar kritik | K03.0–K03.10'a ek olarak K03.11 ile direct CO2=`mg/L as CO2`, indirect estimates explicit derived/indicator, pH/KH chart hard assessment yasağı ve same-event derivation provenance kabul edildi. | Sıradaki K03.12: Fe/K elemental/compound basis + test method semantics. Ardından kalan ek ölçümler; kanıtlı profile/precision tamamlanmalı. |
...
- [ ] W0.6 K03.5–K03.11 politikalarını uygula: marine/salinity, alkalinity, DO, chlorine, Ca/Mg, conductivity/TDS ve CO2 typed semantics. Direct CO2 canonical mg/L as CO2; pH/KH chart/pH-drop/drop-checker outputs measured metric'e yazılmaz; derived method/input provenance ayrı tutulur ve hard health/dosing kararına varsayılan kaynak olmaz. Ardından §25.2'deki Fe/K ve diğer ek ölçüm semantiklerini kesinleştir.
...
- [ ] W1.1 K02 kararına göre mevcut AquariumWaterParameter ve AquariumWaterSnapshot modellerini kontrollü genişlet; K03.1–K03.11 anlam/birimleriyle `ELECTRICAL_CONDUCTIVITY`, `TDS_REPORTED_PPM`, `DISSOLVED_CO2_CONCENTRATION` ve explicit estimated/indicator CO2 result türlerini ekle. Measured/derived semantic'i modelde ayrı olsun.
...
- [ ] W1.4 Parse/normalization öncesi anlamı koru; typed source-profile politikasını kullan. Conductivity için source unit + temperature/reference/ATC basis; TDS için reported ppm + biliniyorsa source factor/scale korunur. TDS kaydetmek için factor zorunlu değildir; yalnız EC↔TDS derivation için gerekir. Device-derived EC+TDS aynı source observation'a bağlanır. Yuvarlama yalnız sunumda.
...
- [ ] W9.3 K03.2–K03.11 semantic/unit/source tests geçsin: conductivity/TDS testlerine ek olarak direct CO2 mg/L round-trip; pH/KH chart not-measured; derived estimate provenance; active-soil/non-carbonate-buffer context'te hard CO2 rejection; pH-drop historical/current input isolation; drop-checker color not fixed ppm; direct measurement precedence; equipment-presence not concentration; missing prerequisites→INSUFFICIENT_DATA.
