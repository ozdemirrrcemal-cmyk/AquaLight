...
- A release candidate is accepted only after Debug/Release unit tests, lint, minified Release, CodeQL, API 27/API 35 instrumentation and targeted physical regression pass.
