...
FILES = {
    ...
    "recovery_store": SOURCE / "data/devices/runtime/modules/firmware/DeviceOtaRecoveryStore.kt",
...
require_tokens(
    "recovery_store",
    (
        "data class DeviceOtaRecoveryRecord(",
        "interface DeviceOtaRecoveryStore",
        "class EncryptedDeviceOtaRecoveryStore(",
...
forbid_tokens("recovery_store", ("context.getSharedPreferences(",))
require_tokens(
    "runtime",
    (
