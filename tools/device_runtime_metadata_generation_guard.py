...
require_tokens(
    ...
    (
        ...
        "SUPPORTED_DEVICE_API_VERSION",
        "reportedApiVersion > SUPPORTED_DEVICE_API_VERSION",
...
require(
    "DeviceCommercialCompatibilityEvaluator.evaluate(this)" in sources["root_mapping"],
    "root projection must delegate runtime-generation and API compatibility to the central evaluator",
)
